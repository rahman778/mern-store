   ...
   return (
      <div className="relative w-full max-w-[24rem] overflow-hidden rounded-sm bg-white shadow-md">
         <a onClick={() => navigate(`/product/${_id}`)} className="cursor-pointer">
            ...
            <img
               className="h-52 rounded-t-lg object-contain mx-auto"
               src={imageUrl}
               alt="product image"
            />
         </a>
         ...
         <div className="mt-0 px-5 pb-5">
            ...
            <div className="mt-2.5 mb-5 flex items-center justify-between">
               ...
               <span class="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded capitalize">{category?.name}</span>
            </div>
